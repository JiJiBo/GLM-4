...
with open(path, 'r', encoding='utf8') as f:
    ...
    for line in lines:
        ...
        if len(answer) > 0 and len(title) > 0:
            user = {"role": "user", "content": answer}
            assistant = {"role": "assistant", "content": title}
            result.append(user)
            result.append(assistant)
end_data = {"messages": result}
# print(end_data)
with open(r"C:\Users\Nas\Downloads\百科类问答json版\baike_qa_train_deal.json", 'w', encoding='utf8') as f:
